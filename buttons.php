...
function Form_admin_actions() {
    add_menu_page("My Buttons", "My Buttons", 'manage_options',__FILE__ , "Form_admin_menu");
    add_submenu_page(__FILE__,'Form','Add New Button','manage_options','form','Form_show_admin_menu');
